...
public class Application extends JFrame {
    ...
    public Application() {
        ...
        map().addMouseMotionListener(new MouseAdapter() {
            ...
            public void mouseMoved(MouseEvent e) {
                ...
                List<MapMarker> markersAtCurrentPos = getMarkersCovering(pos, pixelWidth(p));
                String text;
                if (markersAtCurrentPos.size() > 0) {
                    MapMarkerCircleIcon mm = (MapMarkerCircleIcon) markersAtCurrentPos.get(0);
                    UIManager.put("ToolTip.background", mm.getBackColor());
                    text = "<html><img src=\"" +
                            mm.getTweetImageUrl() +
                            "\">" +
                            mm.getTweetText();
    ...
    public List<MapMarker> getMarkersCovering(ICoordinate pos, double pixelWidth) {
