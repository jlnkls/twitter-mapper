...
public class Util {
    ...
    public static BufferedImage defaultImage = imageFromURL("https://images-na.ssl-images-amazon.com/images/I/51zLZbEVSTL._AC_SY450_.jpg");
    public static BufferedImage imageFromURL(String url) {
        try {
            URL urlObject = new URL(url);
            BufferedImage img = ImageIO.read(urlObject);
